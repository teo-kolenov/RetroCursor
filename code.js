...
function getCursorAsset(cursorType) {
    ...
    const asset = Object.assign({ image }, dimensions);
...
function getScaledDimensions(cursorType, cursorSize) {
...
function applyCursorFill(node, cursorType, cursorSize) {
...
function createCursorImage(cursorType, cursorSize) {
